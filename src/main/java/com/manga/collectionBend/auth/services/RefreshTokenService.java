...
//            long refreshTokenValidity = 5*60*60*1000; // (formate-hrs*mins*sec*millisecond) equal to 5 hours
//            long refreshTokenValidity = 30 * 1000; // =30Sec for testing API purpose
            long refreshTokenValidity = 72*60*60*1000; // (format-hrs*mins*sec*millisecond) equal to 3 days (72 hours)
